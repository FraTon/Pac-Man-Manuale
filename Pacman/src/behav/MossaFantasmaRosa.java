...
public class MossaFantasmaRosa extends MyOneShot {
	...
	public MossaFantasmaRosa(Agent schedAgent,  String filename, String predName, String colore, int X, int Y, int DirPacman, String NX, String NY,String direction) {
	...
	public void action(){
		...
		if (q.hasSolution()){
			...
			String goal = predName + "("+colore+","+X+","+Y+","+DirPacman+",NX,NY,"+direction+")";
